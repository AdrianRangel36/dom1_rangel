...
const nombreAlumno = "Luis Adrián Rangel Vázquez";
const fecha_system = new Date();
...
btnGenerar.addEventListener("click", () => {
  ...
  console.log("La conversión del correo se realizó con exito");
  ...
  console.info(`${nombreAlumno}: ${fecha_system}`);
});
